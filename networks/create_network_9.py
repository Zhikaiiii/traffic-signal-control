...
class NetworkGenerator():
    ...
    def gen_tll_file(self):
        ...
        phases = [('GGGrrrrrGGGrrrrr',15,5,30), ('yyyrrrrryyyrrrrr',3,3,3),
                 ('rrrGrrrrrrrGrrrr',15,5,30), ('rrryrrrrrrryrrrr',3,3,3),
                 ('rrrrGGGrrrrrGGGr',15,5,30), ('rrrryyyrrrrryyyr',3,3,3),
                 ('rrrrrrrGrrrrrrrG',15,5,30), ('rrrrrrryrrrrrrry',3,3,3)]
